...
export const oyoG4Units: Unit[] = [
  ...
  },
  {
    ...
    order: 5,
    realWorldUse:
      "{植物|しょくぶつ}の はの ならび方や、{音楽|おんがく}・もようの くりかえしに かくれて いるよ。{大学|だいがく}の すうれつ・かんすうの {考|かんが}え{方|かた}に つながるよ。",
    leadsTo: [],
    prerequisites: [],
    hasLearn: true,
    hasTest: true,
...
const logicQuestions: Question[] = [
  {
    ...
    explanation:
      "{犬|いぬ}は {動物|どうぶつ}の なかまの 一部だけ。ねこも {動物|どうぶつ}だから「{動物|どうぶつ}は ぜんぶ {犬|いぬ}」は まちがいだよ。{逆|ぎゃく}は いつも 正しいとは かぎらないんだ。",
    visual: { kind: "emoji", value: "🐶🐱🐰", caption: "{動物|どうぶつ}には いろいろ いる" },
    format: "choice",
    choices: ["まちがい", "ただしい", "どちらとも いえない", "犬しか いない"],
    answer: "まちがい",
  },
  {
    id: `${U.logic}.q-2`,
    ...
    explanation:
      "「すべて」を くずすには、あてはまらない {例|れい}が たった 1こ あれば いいよ。あかくない りんごが 1こ でも あれば うそだと いえるんだ（反例）。",
  ...
  },
  {
    ...
    explanation:
      "{本当|ほんとう}の人なら「うそつき」と いわない。うそつきは ほんとうは うそつきだけど『うそ』を いうから「うそつき」とは いえない。どちらでも あわない＝この {発言|はつげん}は ありえないんだ。",
    visual: { kind: "emoji", value: "🤔", caption: "うそつきの パラドックス" },
    format: "choice",
    choices: ["どちらでも ありえない", "Aは {本当|ほんとう}の人", "Aは うそつき", "Bが うそつき"],
    answer: "どちらでも ありえない",
  },
  {
    id: `${U.logic}.q-5`,
    ...
    explanation:
      "「{犬|いぬ}」の なかまにも「ねこ」の なかまにも 入らない ものを えらぶよ。うさぎは どちらでも ない から せいかい。ベン{図|ず}の どちらの {丸|まる}にも 入らない ばしょだね。",
...
const setsQuestions: Question[] = [
  {
    ...
    unitId: U.sets,
    prompt:
      "「{赤|あか}い くだもの」と「{丸|まる}い くだもの」の りょうほうに 入るのは どれ？",
    explanation:
      "りんごは {赤|あか}くて {丸|まる}い。だから ふたつの なかまが かさなる ところ（{共通|きょうつう}）に 入るよ。これを ベン{図|ず}の「かさなり」と いうよ。",
  ...
  },
  {
    ...
    explanation:
      "「{乗|の}りもの」「くだもの」「どうぶつ」のように、おなじ {仲間|なかま}に 入る ものを あつめる ことを「{集合|しゅうごう}を {作|つく}る」と いうよ。",
  ...
  },
  {
    ...
    unitId: U.sets,
    prompt:
      "クラスで いぬが すきな人 8人、ねこが すきな人 5人、{両方|りょうほう}すきな人 3人。いぬ「だけ」すきな人は {何人|なんにん}？",
    explanation:
      "いぬが すき 8人の うち、{両方|りょうほう}すきな 3人を のぞくと いぬ「だけ」が のこるよ。8 ひく 3 で 5人。ベン{図|ず}の かさならない ところだね。",
  ...
  },
  {
    ...
    unitId: U.sets,
    prompt:
      "「{偶数|ぐうすう}（2で わりきれる)」の {集合|しゅうごう}に 入る {数|かず}は どれ？",
    explanation:
      "2で わりきれる {数|かず}を {偶数|ぐうすう}と いうよ。6 は 2で わると 3 で わりきれるから {偶数|ぐうすう}。7 は わりきれないから 入らないよ。",
...
const probabilityQuestions: Question[] = [
  {
    ...
    explanation:
      "さいころには 1・2・3・4・5・6 の 6つの {目|め}が あるよ。{起|お}こりうる ぜんぶの {場合|ばあい}の {数|かず}を かぞえる ことが かくりつの 第一歩だよ。",
  ...
  },
  {
    ...
    unitId: U.probability,
    prompt:
      "あたりくじ。Aは 10本中 2本 あたり、Bは 10本中 5本 あたり。あたりやすいのは？",
    explanation:
      "おなじ 10本でも、あたりが おおい ほうが あたりやすいよ。B（5本）は A（2本）より あたりやすいね。",
...
const statisticsQuestions: Question[] = [
  ...
  },
  {
    ...
    unitId: U.statistics,
    prompt:
      "3人が とった てんすうは 10・8・6。ぜんぶ あわせると {何点|なんてん}？",
    explanation:
  ...
  },
  {
    ...
    unitId: U.statistics,
    prompt:
      "すきな くだものの 人数を、おおい じゅんに ならべると？（りんご5・みかん2・ぶどう8）",
    explanation:
      "おおい じゅんに ならべると ぶどう(8)→りんご(5)→みかん(2)。グラフは おおきい ものから ならべると 見やすいよ。",
  ...
  },
  {
    ...
    explanation:
      "ぼうの {長|なが}さで かずを くらべる グラフを「ぼうグラフ」と いうよ。どれが おおいか ひと目で わかるね。",
  ...
  },
  {
    ...
    explanation:
      "いちばん {多|おお}く でて くる あたいを「さいひんち（モード）」と いうよ。データの とくちょうを つかむ 大切な 見方だよ。",
...
const patternQuestions: Question[] = [
  {
    ...
    explanation:
      "2ずつ ふえて いく きまりだね。8 の つぎは 8＋2＝10。きまりを 見つければ つぎが わかるよ。",
  ...
  },
  {
    ...
    explanation:
      "まえの 2つの {数|かず}を たす きまり（フィボナッチ）だよ。3＋5＝8。{自然|しぜん}の 花びらの {数|かず}にも かくれて いるんだ。",
...
const symmetryQuestions: Question[] = [
  {
    ...
    explanation:
      "ちょうちょは {真|ま}んなかの 線で {折|お}ると 左と右が ぴったり かさなるよ。これを「{線対称|せんたいしょう}」と いうんだ。",
  ...
  },
  {
    ...
    unitId: U.symmetry,
    prompt:
      "アルファベットの「A」を たての 線で {折|お}ると 左右は どうなる？",
    explanation:
      "「A」は たての {真|ま}んなかの 線で {折|お}ると 左と右が かさなる {線対称|せんたいしょう}の もじだよ。「H」「M」「T」も そうだよ。",
  ...
  },
  {
    ...
    explanation:
      "{三角形|さんかくけい}は どの {頂点|ちょうてん}からも 一筆で かけるよ。{線|せん}の あつまる {点|てん}の つながり方で 一筆書きできるか きまる、これが トポロジーの 考え方だよ。",
    visual: { kind: "emoji", value: "🔺", caption: "{三角形|さんかくけい}" },
    format: "choice",
    choices: ["{三角形|さんかくけい}", "ばらばらの 2つの {丸|まる}", "つながって いない 線", "とじて いない ぐちゃぐちゃ"],
    answer: "{三角形|さんかくけい}",
  },
  {
    id: `${U.symmetry}.q-4`,
    unitId: U.symmetry,
    prompt:
      "{正方形|せいほうけい}（ましかく）を 一筆で かく じゅんばんに ならべよう。",
    explanation:
      "かどを じゅんに たどって ①→②→③→④→①に もどると ましかくが 一筆で かけるよ。{頂点|ちょうてん}を きれずに たどるのが コツ。",
    visual: { kind: "emoji", value: "⬜", caption: "かどを じゅんに" },
    format: "ordering",
    items: ["①ひだり上", "②みぎ上", "③みぎ下", "④ひだり下"],
    answerOrder: [0, 1, 2, 3],
  },
  {
    id: `${U.symmetry}.q-5`,
    unitId: U.symmetry,
    prompt:
      "{真|ま}んなかの {点|てん}を {中心|ちゅうしん}に 半かいてん（180ど まわす）しても おなじに 見える もじは？",
    explanation:
      "「S」は 180ど まわしても おなじ かたちに 見えるよ。これを「{点対称|てんたいしょう}」と いうんだ。「N」「Z」も そうだよ。",
  ...
  [U.logic]: {
    ...
    learn: {
      ...
      steps: [
        ...
        {
          heading: "② パズルで たしかめよう",
          body: "「もし {雨|あめ}なら かさを さす」。{雨|あめ}が ふって いるのに かさが なければ おかしいね。じょうけんと けっかを ならべて 手で たしかめよう。",
          visual: { kind: "emoji", value: "🌧️➡️☂️", caption: "もし〜なら" },
        },
        {
          heading: "③ きまりを 見つける（{反例|はんれい}）",
        ...
        {
          heading: "④ やってみよう",
          body: "「{犬|いぬ}は ぜんぶ {動物|どうぶつ}」は 正しい。でも「{動物|どうぶつ}は ぜんぶ {犬|いぬ}」は？ ねこを {反例|はんれい}に すれば まちがいと わかるね。テストで ためそう。",
          visual: { kind: "emoji", value: "🐶🐱", caption: "{逆|ぎゃく}は 正しいとは かぎらない" },
        },
      ],
    },
      ...
      steps: [
        {
          ...
          body: "つみき・ぬいぐるみ・くるまを はこに 分けると かたづけやすいね。おなじ {仲間|なかま}を あつめた もの、それが「{集合|しゅうごう}」だよ。",
          visual: { kind: "emoji", value: "🧸🚗🧱", caption: "なかまで あつめる" },
        },
        {
          heading: "② ベン{図|ず}で かさなりを 見る",
          body: "「{赤|あか}い もの」の {丸|まる}と「{丸|まる}い もの」の {丸|まる}を かさねると、りんごは {両方|りょうほう}に 入る。かさなった ところが「{共通|きょうつう}」だよ。",
          visual: { kind: "emoji", value: "🔴🟡", caption: "ふたつの {丸|まる}の かさなり" },
        },
        {
          heading: "③ きまりを 見つける（だけ・りょうほう）",
          body: "いぬ「だけ」「ねこ だけ」「{両方|りょうほう}」「どちらでも ない」の 4つの ばしょに わかれるよ。たし{算|ざん}・ひき{算|ざん}で 人数が もとめられる。",
          visual: { kind: "emoji", value: "🐶🐱", caption: "4つの ばしょ" },
        },
        {
          heading: "④ やってみよう",
          body: "いぬ すき 8人、{両方|りょうほう}すき 3人なら、いぬ「だけ」は 8−3＝5人。ベン{図|ず}を かいて 手で かぞえて みよう。",
      ...
      steps: [
        {
          ...
          body: "クラスの みんなに すきな くだものを きいて、「正の字」で {数|かず}を かぞえる。これが データ{集|あつ}めの はじまりだよ。",
          visual: { kind: "emoji", value: "🍎🍊🍌", caption: "アンケート" },
        },
        {
          heading: "② 表と グラフで 見える化",
          body: "{集|あつ}めた {数|かず}を 表に かいて、ぼうグラフに すると どれが おおいか ひと目で わかるよ。",
          visual: { kind: "emoji", value: "📊", caption: "ぼうグラフ" },
        },
        {
          heading: "③ きまりを 見つける（へいきん）",
  ...
  [U.pattern]: {
    ...
    learn: {
      ...
      steps: [
        ...
        {
          heading: "② ブロックで ふえ方を 見る",
          body: "2・4・6・8…と ブロックを ならべると、2ずつ ふえて いくのが 目で 見えるよ。",
        ...
        {
          heading: "④ やってみよう",
          body: "きまりが わかれば つぎが よめる。2・4・6・8 の つぎは 10、1・1・2・3・5 の つぎは 8。テストで パターンを 当てて みよう。",
      ...
      steps: [
        {
          ...
          body: "かみに ちょうちょを かいて {真|ま}んなかで {折|お}ると、左と右が ぴったり かさなる。これが「{左右対称|さゆうたいしょう}」だよ。",
          visual: { kind: "emoji", value: "🦋", caption: "{折|お}ると かさなる" },
        },
        {
          heading: "② いろいろな かたちで 体感",
          body: "ハートや 「A」「H」も {真|ま}んなかの 線で 左右が おなじ。「S」は まわすと おなじ（{点対称|てんたいしょう}）。手を うごかして たしかめよう。",
          visual: { kind: "emoji", value: "❤️", caption: "{線|せん}で おりかえす" },
        },
        {
          heading: "③ きまりを 見つける（一筆書き）",
          body: "ペンを はなさず ぜんぶ なぞれる かたちと なぞれない かたちが ある。{線|せん}の あつまる {点|てん}の つながり方で きまるんだ（トポロジー）。",
          visual: { kind: "emoji", value: "🔺", caption: "一筆で かける？" },
        },
        {
          heading: "④ やってみよう",
          body: "{三角形|さんかくけい}や ましかくは かどを じゅんに たどれば 一筆で かける。{対称|たいしょう}な もじ さがしと 一筆書きに ちょうせん しよう。",
