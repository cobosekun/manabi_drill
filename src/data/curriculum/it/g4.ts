...
export const itG4Contents: Record<string, UnitContent> = {
      ...
      steps: [
        {
          ...
          body: "スマホや ゲームきは、{手|て}で さわれる「{機械|きかい}（ハードウェア）」と、その{中|なか}で うごく「アプリや しじ（ソフトウェア）」の 2つで できて いるよ。{人|ひと}の からだ（ハード）と かんがえ（ソフト）の ような かんけいだね。",
          visual: { kind: "emoji", value: "🖥️➕📀", caption: "ハード＋ソフト" },
        },
        {
          heading: "ハードウェア＝さわれる {機械|きかい}",
          body: "{手|て}で さわれる ぶぶんが ハードウェアだよ。キーボード・マウス・{画面|がめん}・プリンターなど、{目|め}に {見|み}えて さわれる もの。だから「{画面|がめん}が われた」のは ハードの こしょうだね。",
          visual: { kind: "emoji", value: "⌨️🖱️🖥️", caption: "さわれる きかい" },
        },
        {
          heading: "ソフトウェア＝さわれない しじ",
          body: "さわれない、コンピュータを うごかす アプリや しじが ソフトウェアだよ。ゲーム・ブラウザ・おえかきアプリは ぜんぶ ソフト。{同|おな}じ スマホでも アプリを いれかえると できる ことが かわるね。",
          visual: { kind: "emoji", value: "🎮", caption: "アプリ＝ソフト" },
        },
        {
          heading: "{両方|りょうほう}そろって はじめて うごく",
          body: "{機械|きかい}（ハード）だけでも、しじ（ソフト）だけでも うごかないよ。{両方|りょうほう}が そろって はじめて しごとが できるんだ。コンピュータの {中|なか}で けいさんや かんがえる しごとを する あたまの ぶぶんを「CPU」と いうよ。",
          visual: { kind: "emoji", value: "🧠", caption: "CPU＝けいさんの あたま" },
        },
      ],
    },
    test: {
      ...
      steps: [
        {
          ...
          body: "コンピュータは「{入力|にゅうりょく}（いれる）→ {処理|しょり}（かんがえる）→ {出力|しゅつりょく}（だす）」の じゅんで しごとを するよ。これは どんな コンピュータでも おなじ、きほんの ながれなんだ。",
          visual: { kind: "emoji", value: "⌨️➡️🧠➡️🖥️", caption: "いれる→かんがえる→だす" },
        },
        {
          heading: "{入力|にゅうりょく}＝いれる どうぐ",
          body: "キーボードで {文字|もじ}、マイクで こえ、カメラで {絵|え}——{情報|じょうほう}を コンピュータに いれる どうぐが {入力|にゅうりょく}だよ。マウスや ゲームの コントローラーも なかまだね。",
          visual: { kind: "emoji", value: "⌨️🎤📷", caption: "いれる{係|がかり}" },
        },
        {
          heading: "{出力|しゅつりょく}＝だす どうぐ",
          body: "{画面|がめん}に {絵|え}、スピーカーに {音|おと}、プリンターに かみ——けっかを そとに だす どうぐが {出力|しゅつりょく}だよ。{矢印|やじるし}の むきが コンピュータから そとへ なら「だす」だね。",
          visual: { kind: "emoji", value: "🖥️🔊🖨️", caption: "だす{係|がかり}" },
        },
        {
          heading: "{両方|りょうほう}の はたらきを もつ どうぐ",
          body: "タッチパネルは、{指|ゆび}で さわって いれる（{入力|にゅうりょく}）と、{画面|がめん}に だす（{出力|しゅつりょく}）の {両方|りょうほう}を もつ どうぐだよ。1つで 2つの しごとを する ものも あるんだ。",
          visual: { kind: "emoji", value: "👆📱", caption: "さわって いれる＋だす" },
        },
      ],
    },
    test: {
      ...
      steps: [
        {
          ...
          body: "コンピュータは「0」と「1」の 2つの しるしだけで、{文字|もじ}も {絵|え}も {音|おと}も ぜんぶ あらわすよ。これを「2しんすう」と いうよ。でんきが「ついて いる＝1・きえて いる＝0」と かんがえると わかりやすいね。",
          visual: { kind: "emoji", value: "0️⃣1️⃣", caption: "0 と 1" },
        },
        {
          heading: "ビットを 8こ あつめて 1バイト",
          body: "0 か 1 ひとつぶんが「1ビット」、それを 8こ あつめると「1バイト」だよ。1バイトで ひらがな1{文字|もじ}ぶんくらいを あらわせるんだ。8こ かぞえて みよう。",
          visual: { kind: "anim", name: "count-up", params: { to: 8, emoji: "🔘" }, caption: "8ビット＝1バイト" },
        },
        {
          heading: "データには {大|おお}きさが ある",
          body: "{文字|もじ}より {写真|しゃしん}、{写真|しゃしん}より {動画|どうが}の ほうが データが ずっと {大|おお}きいよ。{大|おお}きい データほど ほぞんの ばしょを たくさん つかい、おくるのにも {時間|じかん}が かかるんだ。",
          visual: { kind: "anim", name: "grow", params: { stages: ["🔤", "🖼️", "🎞️"] }, caption: "{文字|もじ}→{写真|しゃしん}→{動画|どうが}と {大|おお}きく" },
        },
        {
          heading: "ほぞんが いっぱいに なったら",
          body: "{写真|しゃしん}や {動画|どうが}を ほぞんして おく ところが「{記憶|きおく}そうち」。USBメモリや SDカードが なかまだよ。いっぱいに なったら、いらない データを けすと ばしょ（{容量|ようりょう}）が あくんだ。",
          visual: { kind: "anim", name: "blocks-remove", params: { total: 8, remove: 3 }, caption: "いらない データを けす" },
        },
      ],
    },
    test: {
  ...
  [U.internet]: {
    ...
    learn: {
      ...
      steps: [
        {
          heading: "せかいを つなぐ {大|おお}きな あみ",
          body: "インターネットは せかいじゅうの コンピュータを つないだ {大|おお}きな「あみ（ネットワーク）」だよ。あみの ように たくさん つながって いるから、{遠|とお}くの {国|くに}の {人|ひと}とも すぐに つながれるんだ。",
          visual: { kind: "emoji", value: "🌐", caption: "せかいの あみ" },
        },
        {
          heading: "サーバーと Wi-Fi",
          body: "ホームページや {動画|どうが}を おいて、みんなに わたす がわの コンピュータを「サーバー」と いうよ。ケーブル（{線|せん}）なしで、{電波|でんぱ}で つなぐ しくみが「Wi-Fi」だね。",
          visual: { kind: "emoji", value: "🗄️📶", caption: "サーバーと Wi-Fi" },
        },
        {
          heading: "データは つたって とどく",
          body: "おくった メッセージは {小|ちい}さく わけられて、いくつもの コンピュータを {通|とお}って {相手|あいて}に とどくよ。とちゅうで たすけあって はこぶから、とおくても とどくんだ。",
          visual: { kind: "emoji", value: "✉️➡️🌐➡️📱", caption: "つたって とどく" },
        },
        {
          heading: "サーバーは ずっと うごいて いる",
          body: "みんなが いつ {見|み}ても いい ように、サーバーは よるも ひるも、24{時間|じかん} ずっと うごいて いるよ。とても べんりだけど、つかいすぎには {気|き}を つけようね。",
          visual: { kind: "anim", name: "clock-tick", params: { hour: 3, minute: 0, fromHour: 12, fromMinute: 0 }, caption: "24{時間|じかん} うごく" },
        },
      ],
    },
    test: {
      ...
      steps: [
        {
          ...
          body: "パスワードは じぶんだけの「かぎ」だよ。{名前|なまえ}や たんじょうびは すぐ ばれて しまうから、あてられにくい ながい ことばに しよう。{人|ひと}に おしえないのも だいじだね。",
          visual: { kind: "emoji", value: "🔑", caption: "ひみつの かぎ" },
        },
        {
          heading: "{個人|こじん}じょうほうは {出|だ}さない",
          body: "じゅうしょ・でんわばんごう・{学校|がっこう}の {名前|なまえ}・かおじゃしんは、しらない {人|ひと}に おしえては だめだよ。これを「{個人|こじん}じょうほう」と いうよ。ネットに {一|いち}ど のせると きえないんだ。",
          visual: { kind: "emoji", value: "🚫🏠", caption: "じゅうしょは ひみつ" },
        },
        {
          heading: "あやしい ものは むやみに おさない",
          body: "しらない ホームページの「ここを おして」や、へんな メッセージは むやみに おさないでね。ウイルスや わるい しくみが かくれて いる ことが あるんだ。",
          visual: { kind: "emoji", value: "⚠️", caption: "おす まえに かんがえる" },
        },
        {
          heading: "ネットでも やさしく・こまったら そうだん",
          body: "{相手|あいて}の {顔|かお}が {見|み}えなくても、やさしい ことばで つたえよう。いやな ことや こまった ことが あったら、すぐ おとなに そうだんしてね。",
          visual: { kind: "emoji", value: "😊💬", caption: "やさしい ことば" },
        },
      ],
    },
      ...
      steps: [
        {
          ...
          body: "やる ことを {正|ただ}しい じゅんに ならべた ものを「アルゴリズム（{手順|てじゅん}）」と いうよ。りょうりの レシピや、{朝|あさ}の したくの じゅんばんも なかまだね。",
          visual: { kind: "emoji", value: "📋", caption: "{手順|てじゅん}" },
        },
        {
          heading: "じゅんが ちがうと うまく いかない",
          body: "カップめんなら「ふたを あける → おゆを いれる → まつ」。「おゆを いれる」を さきに すると、ふたが しまって いて いれられないね。だから {正|ただ}しい じゅんが だいじなんだ。",
          visual: { kind: "emoji", value: "🍜", caption: "じゅんばんが だいじ" },
        },
        {
          heading: "フローチャートで {見|み}える{化|か}",
          body: "{矢印|やじるし}や はこで ながれを かいた {図|ず}を「フローチャート」と いうよ。{手順|てじゅん}が {一目|ひとめ}で わかるから、だれが やっても {同|おな}じ けっかに なるんだ。",
          visual: { kind: "emoji", value: "🔽", caption: "ながれの {図|ず}" },
        },
        {
          heading: "ロボットへの しじにも つかう",
          body: "アルゴリズムは、ロボットや コンピュータへの しじにも つかうよ。「もし〜なら」や「〜を くりかえす」を くみあわせると、ふくざつな しごとも きちんと できるんだ。",
          visual: { kind: "emoji", value: "🤖", caption: "しじの くみあわせ" },
        },
      ],
    },
    test: {
  ...
  [U.sortSearch]: {
    ...
    learn: {
      ...
      steps: [
        {
          heading: "ならべかえ（ソート）",
          body: "データを {小|ちい}さい じゅんや {大|おお}きい じゅんに そろえる ことを「ソート（ならべかえ）」と いうよ。1・2・3・…と {番号|ばんごう}じゅんに ならべて おくと、あとで べんりなんだ。",
          visual: { kind: "anim", name: "count-up", params: { to: 5, emoji: "🔢" }, caption: "{小|ちい}さい じゅんに ならぶ" },
        },
        {
          heading: "ならんで いると さがしやすい",
          body: "じゅんに ならんで いれば、{目|め}あての ものを はやく さがせるよ。じてんや でんわちょうが あいうえおじゅんなのも、はやく さがす ための くふうだね。",
          visual: { kind: "emoji", value: "📚", caption: "さがしやすい" },
        },
        {
          heading: "はんぶんずつ へらして さがす",
          body: "ならんで いる ものは、まん{中|なか}を {見|み}て「もっと さき？ てまえ？」と きめると、のこりを はんぶんに へらせるよ。これを くりかえすと、ぜんぶ {見|み}るより ずっと はやく さがせるんだ。",
          visual: { kind: "anim", name: "blocks-remove", params: { total: 8, remove: 4 }, caption: "はんぶんに へらす" },
        },
        {
          heading: "ステップが {少|すく}ない＝{効率|こうりつ}が よい",
          body: "{同|おな}じ こたえでも、{少|すく}ない {手順|てじゅん}（ステップ）で できる ほうが はやいね。これを「{効率|こうりつ}が よい」と いうよ。けんさくが はやいのも、この くふうの おかげなんだ。",
          visual: { kind: "emoji", value: "⚡", caption: "はやい {手順|てじゅん}" },
        },
      ],
    },
      ...
      steps: [
        {
          ...
          body: "コンピュータに させたい ことを かいた しじの あつまりを「プログラム」と いうよ。それを {作|つく}る ことが「プログラミング」だね。ゲームも アプリも、ぜんぶ プログラムで うごいて いるんだ。",
          visual: { kind: "emoji", value: "🧩", caption: "しじの あつまり" },
        },
        {
          heading: "ブロックを つんで {作|つく}る",
          body: "ブロックを はめこんで しじを くみたてる やりかたが「ブロックプログラミング」だよ。{文字|もじ}を まちがえず、パズルの ように くみたてられるから はじめやすいんだ。",
          visual: { kind: "emoji", value: "🧱", caption: "はめこむ だけ" },
        },
        {
          heading: "うえから じゅんに うごく",
          body: "プログラムは うえから したへ、1つずつ じゅんに {実|じっ}こうされるよ。「{右|みぎ}に すすむ → ジャンプする → なく」と ならべると、その じゅんに キャラクターが うごくんだ。",
          visual: { kind: "emoji", value: "🐱", caption: "じゅんに うごく" },
        },
        {
          heading: "じゅんを かえると うごきも かわる",
          body: "ブロックの じゅんを いれかえると、キャラクターの うごきも かわるよ。おもいどおりに うごくように、じゅんを かんがえて ならべるのが たのしい ところだね。",
          visual: { kind: "emoji", value: "🔀", caption: "じゅんを かえる" },
        },
      ],
    },
    test: {
      ...
      steps: [
        {
          ...
          body: "とくてんや のこり{回数|かいすう}など、かわる {数|かず}を おぼえて おく「いれもの」を「{変数|へんすう}」と いうよ。はこに ラベルを はって、{中|なか}みを かきかえる イメージだね。",
          visual: { kind: "emoji", value: "📦", caption: "あたいの いれもの" },
        },
        {
          heading: "とくてんが ふえて いく",
          body: "コインを とるたびに、{変数|へんすう}「とくてん」に 1を たして いくよ。0から はじまって どんどん ふえて いく——これが {変数|へんすう}の つかいかただね。",
          visual: { kind: "anim", name: "count-up", params: { to: 5, emoji: "⭐" }, caption: "とくてんが ふえる" },
        },
        {
          heading: "くりかえし（ループ）",
          body: "{同|おな}じ うごきを なんども する ときは「くりかえし」を つかうよ。「10かい すすむ」と かけば、10こ ブロックを ならべなくても 1つで すむんだ。",
          visual: { kind: "anim", name: "count-up", params: { to: 10 }, caption: "10かい くりかえす" },
        },
        {
          heading: "じょうけん（もし〜なら）",
          body: "「もし ボタンが おされたら {音|おと}を ならす」のように、ばあいに よって うごきを かえる しくみが「じょうけん」だよ。{変数|へんすう}・くりかえし・じょうけんを あわせると、ふくざつな うごきが {作|つく}れるんだ。",
          visual: { kind: "emoji", value: "❓", caption: "もし〜なら" },
        },
      ],
    },
  ...
  [U.debug]: {
    ...
    learn: {
      ...
      steps: [
        {
          heading: "バグと デバッグ",
          body: "プログラムの まちがいを「バグ（{虫|むし}）」、それを {見|み}つけて {直|なお}す ことを「デバッグ」と いうよ。どんな じょうずな {人|ひと}でも バグは おこるから、はずかしい ことじゃ ないんだ。",
          visual: { kind: "emoji", value: "🐛", caption: "バグ＝まちがい" },
        },
        {
          heading: "1つずつ たしかめる",
          body: "おもいどおりに うごかない ときは、{上|うえ}から 1つずつ「ここまでは あって いる？」と たしかめよう。やみくもに {直|なお}さず、どこで おかしく なるか さがすのが こつだよ。",
          visual: { kind: "emoji", value: "🔎", caption: "1つずつ さがす" },
        },
        {
          heading: "みつけたら 1つずつ なおす",
          body: "バグを {見|み}つけたら、1つずつ ていねいに {直|なお}して いこう。いちどに たくさん かえると、どれが きいたか わからなく なって しまうからね。",
          visual: { kind: "anim", name: "blocks-remove", params: { total: 3, remove: 3 }, caption: "バグを なおす" },
        },
        {
          heading: "{直|なお}したら もう{一|いち}ど たしかめる",
          body: "「うごかす → {見|み}つける → {直|なお}す → もう{一|いち}ど たしかめる」を くりかえすよ。{直|なお}した あとに たしかめると、ちゃんと なおったか・ほかが こわれて いないか わかるんだ。",
          visual: { kind: "emoji", value: "✅", caption: "たしかめる" },
        },
      ],
    },
