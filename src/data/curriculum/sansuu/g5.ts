...
export const sansuuG5Units: Unit[] = [
  ...
  },
  {
    ...
    order: 10,
    realWorldUse:
      "テストの {平均点|へいきんてん}や、1{日|にち}に {読|よ}む {本|ほん}の ページ{数|すう}のように、でこぼこした {数|かず}を ならして {表|あらわ}すときに {使|つか}うよ。",
      ...
      steps: [
        {
          ...
          body: "{数|かず}を 10{倍|ばい} すると {位|くらい}が ひとつ {上|あ}がって、{点|てん}が {右|みぎ}へ {動|うご}くよ。100{倍|ばい}なら ふたつ {上|あ}がるよ。",
          visual: { kind: "emoji", value: "2.5 → 25 → 250", caption: "10{倍|ばい}・100{倍|ばい}" },
        },
        {
          heading: "1/10・1/100にすると?",
          body: "{数|かず}を 1/10 にすると {位|くらい}が ひとつ {下|さ}がって、{点|てん}が {左|ひだり}へ {動|うご}くよ。100{分|ぶん}の1なら ふたつ {下|さ}がるよ。",
      ...
      questions: [
        {
          ...
          explanation: "10{倍|ばい}すると {位|くらい}が ひとつ {上|あ}がるよ。{点|てん}が {右|みぎ}へ {動|うご}いて 25 になるよ。",
          format: "number-input",
          answer: 25,
        },
        {
          ...
          explanation: "1/10 にすると {位|くらい}が ひとつ {下|さ}がるよ。{点|てん}が {左|ひだり}へ {動|うご}いて 3.8 になるよ。",
          format: "number-input",
          answer: 3.8,
        },
        {
        ...
        },
        {
          ...
          explanation: "100{倍|ばい}は {位|くらい}が ふたつ {上|あ}がるよ。6.2 → 62 → 620 で 620 だよ。",
          format: "number-input",
          answer: 620,
        },
        {
          ...
          explanation: "1/100 は {位|くらい}が ふたつ {下|さ}がるよ。4.5 → 0.45 → 0.045 で 0.045 だよ。",
          format: "number-input",
          answer: 0.045,
        },
      ],
    ...
    learn: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "ふたつの {数|かず}に {共通|きょうつう}の {倍数|ばいすう}が {公倍数|こうばいすう}、{共通|きょうつう}の {約数|やくすう}が {公約数|こうやくすう}。いちばん {小|ちい}さい/{大|おお}きい ものに {注目|ちゅうもく}するよ。",
    ...
    test: {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: "12の {約数|やくすう}と 18の {約数|やくすう}で {共通|きょうつう}の いちばん {大|おお}きい {数|かず}は 6 だよ。",
          format: "number-input",
          answer: 6,
        },
        {
      ...
      steps: [
        {
          ...
          body: "{点|てん}を ないものとして {整数|せいすう}の ように {掛|か}けて、{最後|さいご}に もとの {小数|しょうすう}の {桁|けた}{分|ぶん} {点|てん}を {打|う}つよ。2.4 × 3 なら 24 × 3 = 72 → 7.2。",
        ...
        },
        {
          ...
          body: "1.5 × 0.4 のように 1より {小|ちい}さい {数|かず}を {掛|か}けると、{答|こた}えは もとの {数|かず}より {小|ちい}さく なるよ。",
    ...
    learn: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "{円|えん}の まわりの {長|なが}さ（{円周|えんしゅう}）は「{直径|ちょっけい} × 3.14」で {求|もと}めるよ。3.14 を {円周率|えんしゅうりつ} というよ。",
      ...
      steps: [
        {
          ...
          body: "「1こあたり いくら」「1{人|にん}あたり {何|なん}こ」のように、ひとつ {分|ぶん}に そろえると {比|くら}べやすく なるよ。",
  ...
  [U.bandPieGraph]: {
    ...
    learn: {
      ...
      steps: [
        ...
        {
          heading: "{帯|おび}グラフ",
          body: "{長|なが}い {帯|おび}を {割合|わりあい}で {区切|くぎ}るよ。ふつう {割合|わりあい}の {大|おお}きい ものから {左|ひだり}に {並|なら}べるよ。",
    ...
    test: {
      ...
      questions: [
        ...
        },
        {
          ...
          unitId: U.bandPieGraph,
          prompt: "{帯|おび}グラフでは ふつう {割合|わりあい}の {大|おお}きい ものを どこから {並|なら}べる?",
