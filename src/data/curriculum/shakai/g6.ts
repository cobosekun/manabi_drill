  ...
  [U.election]: {
    ...
    learn: {
      ...
      steps: [
        ...
        {
          heading: "18さいからとうひょう",
          body: "{今|いま}の{日本|にほん}では18さいになるととうひょうできるよ。きみたちも{大|おお}きくなったら{国|くに}や{町|まち}をえらぶ{役|やく}をもつんだ。",
    ...
    learn: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "{昭和|しょうわ}になると{大|おお}きな{戦争|せんそう}がおこり、{日本|にほん}もまきこまれたよ。{空襲|くうしゅう}やそかいで、くらしはとてもくるしかったよ。",
