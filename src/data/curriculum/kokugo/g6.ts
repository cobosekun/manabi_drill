...
const wordChangeQuestions: ChoiceQuestion[] = [
  {
    id: `${U.wordChange}.q-1`,
    unitId: U.wordChange,
    prompt: "古語「いと」は {今|いま}の どの {意味|いみ}に ちかい？",
    explanation: "古語の「いと」は「とても・たいへん」の {意味|いみ} だよ。",
    format: "choice",
  ...
  },
  {
    ...
    explanation: "そとの {国|くに}から きた ことば=外来語。カタカナで {書|か}くことが おおい。",
    format: "choice",
  ...
  },
  {
    ...
    explanation: "{昔|むかし}から にほんに ある ことば=和語。{訓読|くんよ}みで {読|よ}むことが おおい。",
    format: "choice",
  ...
  },
  {
    ...
    explanation: "{漢字|かんじ}の {音読|おんよ}みで {読|よ}む ことば=漢語。{中国|ちゅうごく}から つたわった ことば。",
    format: "choice",
...
const classicsQuestions: ChoiceQuestion[] = [
  ...
  },
  {
    ...
    explanation: "「春は あけぼの」は 枕草子の ゆうめいな はじまりの {文|ぶん}。",
    format: "choice",
  ...
  },
  {
    id: `${U.classics}.q-4`,
    unitId: U.classics,
    prompt: "古語「あけぼの」の {意味|いみ}に ちかいのは？",
  ...
  [U.classics]: {
    ...
    learn: {
      ...
      steps: [
        ...
        {
          heading: "竹取物語",
          body: "「いまは むかし、竹取の おきな と いう もの ありけり」で はじまる、かぐやひめの おはなし。にほんで いちばん ふるい {物語|ものがたり}の ひとつだよ。",
          visual: { kind: "emoji", value: "🎋🌕", caption: "かぐやひめ" },
        },
        {
          heading: "枕草子",
          body: "せいしょうなごんが {書|か}いた ずいひつ。「春は あけぼの」で はじまり、きせつの すてきな ようすを えがいて いるよ。",
